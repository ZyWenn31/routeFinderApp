...
public class FlightService {
    ...
    private TargetFlightDTO findRoutes(TargetRoute targetRoute){
        ...
        List<List<FlightDTO>> flights = routeFinder.findRoutes(cityService.findCityByNAme(targetRoute.getDepartureCity()),
                        cityService.findCityByNAme(targetRoute.getArrivalCity()), targetRoute.getDeparture())
                .stream()
